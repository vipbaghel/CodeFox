...
if(error)  toast.error(error.message,{position:"top-center",autoClose:3000,theme:"dark"});
    ...
    return <form className='space-y-6 px-6 py-4' onSubmit={handleLogin}>
        ...
        <div>
            ...
            bg-gray-600 border-gray-500 placeholder-gray-400 text-white' placeholder='name@company.com' onChange={handleInputChange} />
        ...
        <div>
            ...
            bg-gray-600 border-gray-500 placeholder-gray-400 text-white' placeholder='*********'  onChange={handleInputChange} />
        ...
        <button className='flex w-full justify-end' onClick={()=> handleClick("forgotPassword")}>z
