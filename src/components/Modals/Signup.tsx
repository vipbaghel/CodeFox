...
useEffect(()=>{
    ...
    return (
        ...
        <div>
            ...
            bg-gray-600 border-gray-500 placeholder-gray-400 text-white' placeholder='name@company.com' onChange={handleChangeInput} />
        ...
        <div>
            ...
            bg-gray-600 border-gray-500 placeholder-gray-400 text-white' placeholder='XYZ' onChange={handleChangeInput} />
        ...
        <div>
            ...
            bg-gray-600 border-gray-500 placeholder-gray-400 text-white' placeholder='*********' onChange={handleChangeInput} />
